...
class MediumFragment : Fragment(R.layout.fragment_medium) {
    ...
    private val args by navArgs<MediumFragmentArgs>()
    private val viewModel by viewModels<PointsViewModel> { PointsViewModelFactory(AppDatabase.getDb(requireContext()).PlayerDao()) }
    private val imageArray = arrayOf(1, 2, 3, 4, 5, 6, 7, 8)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentMediumBinding.bind(view)
        points1 = 0
        points2 = 0
        currentImage = 1
        currentTurn = 1
            ...
            countDownTimer = object : CountDownTimer(timeShared.toLong(), 1000) {
                ...
                override fun onFinish() {
                    ...
                    dialogBinding.btnScores.setOnClickListener {
                        alertDialog.dismiss()
                        findNavController().navigate(R.id.action_mediumFragment_to_scoresFragment)
                    }
    ...
    private fun saveData(name:String,points:Int,time: String) {
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenCreated {
            viewModel.savePlayer(PlayerEntity(0,name,p,2,time)).collect {
                when(it) {
                    is Results.Success -> {
                    }
                }
